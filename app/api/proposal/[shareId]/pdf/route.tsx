...
export async function GET(
  ...
  const { data: proposal } = await supabase
    .from("proposals")
    .select(
      "id, title, user_id, client_name, client_company, generated_content, budget_amount, budget_currency, subtotal, discount_percent, tax_percent, grand_total, line_items_enabled",
    )
    .eq("share_id", shareId)
    .single();
